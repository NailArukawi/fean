...
pub const Opcode = extern struct {
    ...
    pub inline fn getX(this: @This()) u24 {
        return @as(*u24, @ptrFromInt(@intFromPtr(&this.a))).*;
    }

    pub inline fn getY(this: @This()) u16 {
        return @as(*u16, @ptrFromInt(@intFromPtr(&this.b))).*;
    }

    pub inline fn setX(this: *@This(), val: u32) void {
        @as(*u24, @ptrFromInt(@intFromPtr(&this.b))).* = val;
    }

    pub inline fn setY(this: *@This(), val: u16) void {
        @as(*u16, @ptrFromInt(@intFromPtr(&this.b))).* = val;
    }
};
